...
<header>
    <div class="overlay">
        <div class="imgSection">
            <img src="assets/image/UOCLogo.png" alt="UOC_logo"/>
        </div>
        <div class="textSection">
            <span class="mainText">University Student-Staff Portal</span>
        </div>
        <div class="imgSection">
            <img src="assets/image/UCSCLogo.png" alt="UCSC_logo"/>
        </div>
        <h3 class="uniName">University of Colombo School of Computing<br>Sri Lanka</h3>
    </div>
</header>
<div class="loginInfo">
    <h4>Login as Chathura &nbsp;<span><a href="#" style="color: white;"><i class="fas fa-sign-out-alt"
                                                                           style="color: white;"></i></a></span></h4>
</div>
