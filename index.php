...
<header>
    <div class="overlay">
            <div class="imgSection">
                <img src="assets/image/UOC_logo.png" alt="UOC_logo"/>
            </div>
            <div class="textSection">
                <span class="mainText">University Student-Staff Portal</span>
            </div>
            <div class="imgSection">
                <img src="assets/image/UCSC_logo.png" alt="UCSC_logo"/>
            </div>
        <h3 class="uniName">University of Colombo School of Computing<br>Sri Lanka</h3>
    </div>
</header>
<div class="loginInfo">
    <h4>Login as Chathura &nbsp;<span><a href="#" style="color: white;"><i class="fas fa-sign-out-alt" style="color: white;"></i></a></span></h4>
</div>
...
<div class="content">
        ...
        <div class="row col-5">
            ...
            <div class="profileSection">
                ...
                <div class="profilePic">
                    <img src="assets/image/userMale.jpg" alt="profilePic" style="height: auto;width: 100%;margin: auto">
                </div>
                <div class="userInfo">
                    <span class="name">W.A.C.J.<br>Wanniarachchci</span><br>
                    <span class="emailPersonal">wchaturaj@gmail.com</span><br>
                    <span class="emailUniversity">2018cs183@ucsc.cmb.ac.lk</span><br>
                    <span class="gpa green">3.653</span>
    ...
    <div class="linkSection">
        <div class="row col-6">
            ...
            <a href="#" class="tile">
                <div class="tileImage"><i class="fas fa-stream  fa-3x"></i></div>
                <div class="tileDescription">Review Exam Result</div>
            </a>
            <a href="#" class="tile">
