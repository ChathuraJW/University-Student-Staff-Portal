...
<div class="featureBody row col-1  bodyBackground text">
    <div style="float:left;">
        <button class="button link" id="linkOne" check="0" onclick="scheduleCheck()">History</button>
        <br></div>
    <div class="row col-2" id="main">
        ...
        <div class="replyMessageViewer"><!-- View the message content of each message  -->
            ...
            <div id="workloadRequest" style="display:none;">
                <button class="close" style="float:right;padding-right:10px;" onclick="closeFirst()"><i class="fa fa-times-circle"
    ...
    <div class="row col-2 schedule" id="schedule" style="display:none;"><!--display the history of the supportive staff -->
        <div>
            <button style="cursor:pointer;" class="button" onclick="openForm();">Add my workload</button>
        </div>
        <div></div>
        <div>
            <h2 class='head' style="margin-bottom:20px;">My Workload &nbsp;&nbsp;&nbsp;&nbsp;<i title="Download" class="fa fa-arrow-circle-down"
        ...
        <div class="displayContent">
            ...
            <div class="scheduleDescription" id="scheduleDescription" style="display:none;">
                <div class="scheduleMessage">
                    <button class="close" style="float:right;padding-right:10px;" onclick="closeSecond()"><i class="fa fa-times-circle"
                                                                                                             aria-hidden="true"></i></button>
                    ...
                    <div style="padding-top:40px;">
                        ...
                        <div class="displayingMessage" style="margin-bottom:10px;">
                            <div class="label">Description</div>
                            <div class="value" id="newDescription"> Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when
                                an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five
                            </div>
                        </div>
                        <div class="displayingMessage">
                            <div class="label">Reply</div>
                            <div class="value" id="newReply">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an
                                unknown printer
                            </div>
                        </div>
                    </div>
            ...
            <div class="scheduleDescription" id="myWorkloadForm" style="display:none;">
                <form action="" method="post">
                    <div class="scheduleMessage">
                        <button class="close" style="float:right;padding-right:10px;" onclick="closeThird()"><i class="fa fa-times-circle"
                                                                                                                aria-hidden="true"></i></button>
                        <!-- <h3 class="topic" id="newTitle">Assignment conducting for DSA</h3> -->
                        ...
                        <div style="padding-top:40px;">
                            ...
                            <div class="displayingMessage">
                                <div class="label">Location</div>
                                <div class="value" id="newLocation"><input type="text" name="location" value="my location" default="My location">
                                </div>
                            </div>
                            <div class="displayingMessage">
                                <div class="label">Date</div>
                            ...
                            <div class="displayingMessage" style="margin-bottom:10px;">
                                ...
                                <div class="value" id="newDescription"><textarea name="description" id="" cols="30" rows="10"
                                                                                 value="aaaaaaaaaaa"></textarea></div>
                            </div>
                            <div class="buttonCouple ">
