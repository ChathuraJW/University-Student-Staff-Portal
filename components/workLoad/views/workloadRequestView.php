				...
				<?php foreach ($records as $record) { ?>
                    ...
                    <div class="row col-1">
                        ...
                        <span class="appointment text"><div style="margin-bottom:10px;"
                                                            class="appointmentDescription messageHead"><?php echo $record['title']; ?></div><div
                                    class="appointmentDescription"><?php echo substr($record['description'], 0, 80); ?> </div><div
                                    class="appointmentDescription" style="float:right;"><i class='fa fa-clock-o'
                                                                                           aria-hidden='true'></i>  <?php echo $record['requestDate']; ?></div></span><br>
