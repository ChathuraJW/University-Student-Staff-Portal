			...
			<?php if (isset($_GET['fullName'])): ?>
                ...
                <div id="workloadRequest">
                    ...
                    <div style="margin-top:10px;" class="displayingMessage">
                        <div class="label">
                            <button class="button" onclick="messageClose()">Cancel</button>
                        </div>
                        <div style="text-align:center;" class="value">
                            <button class="button" onclick="allocation()">Allocate</button>
                        </div>
                    </div>
                </div>
			<?php endif; ?>
    ...
    <div class="row col-2" id="secondaryMain" style="display:none;">
            ...
            <form id="allocationForm" class="search" id="search" method="post" action="">
                ...
                <div class="row col-2">
                    ...
                    <div style="text-align:center;width:80px;margin-left:25%;">
                        <button class="button searchButton" id="search" type="button" onclick="displaySearch()" name="submit">Search <i
            ...
            <div>
                ...
                <form action="" method="post" id="allocationForm">
                    <div id="searchStaff" style="color:black;display:none;"><!-- here display the all supportive staff free in mentioned time slot -->
                        ...
                        <div class="text" style="margin-top:10px;">If You Want Select More Than One Member Select Members with Pressing CTRL Button
                        </div>
						<?php
							// for($i=1;$i<12;$i++){
							// echo
        ...
        <div class="allocateForm" id="allocateForm" style="display:none;">
            ...
            <div class="displayingMessage allocationInput">
                ...
                <div class="value"><textarea class="input" type="" value="" id="description"
                                             readonly><?php echo $_GET['workLoadDescription'] ?></textarea></div>
            </div>
            <div class="row col-2">
