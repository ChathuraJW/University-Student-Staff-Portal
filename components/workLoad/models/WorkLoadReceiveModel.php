<?php
    class WorkLoadReceiveModel extends Model{
        public static function getWorkLoadMessages($sign){
            ...
            $messages=Database::executeQuery("root","","SELECT * FROM workload,academic_support_staff_workload,user WHERE academic_support_staff_workload.staffID='kek' AND academic_support_staff_workload.workloadID=workload.workloadID AND user.username='kek' AND academic_support_staff_workload.isChecked=$sign;");
