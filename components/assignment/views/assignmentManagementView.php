    ...
    <div class="row col-2">
        ...
        <div class="actionSection">
            <form action="" method="post">
                ...
                <div class="row col-2">
                    <div class="showRest">
                        <span>Subject <button style="border: none;background-color: transparent;" onclick="location.reload();"><i class="fas fa-sync"></i></button></span>
                ...
                <div class="row col-2">
                    <div class="showRest">
                        ...
                        <input type="number" name="assignmentWeight" id="assignmentWeight" max="1" min="0" step="0.01" required>
                    </div>
                    <div class="showRest">
                        <span>Number of Assignments </span>
                        <input type="number" name="totalAssignment" id="totalAssignment" required>
                    </div>
                </div>
                <div class="row col-1">
                    <div class="showRest">
                ...
                <span class="staffAddSectionHead">Assignment Plane Conducted By <button style="border: none;background-color: transparent;" onselect="location.reload();"><i class="fas fa-sync"></i></button></span>
                <div class="row col-2">
                    <div>
                        <select name="academicSupportList" id="academicSupportList" onchange="addStaffRecipient();" required>
                            <option value="nim">Samanthika Perera</option>
                            <option value="abc">Saman Perera</option>
                            <option value="mnh">Soma Gunasekare</option>
                            <option value="qqw">Ruvan Hemarathna</option>
                        </select>
                    </div>
                    <div>
                        <textarea name="conductStaffList" id="conductStaffList" cols="30" rows="4"></textarea>
                    </div>
                </div>
                <br>
                <div class="row col-2">
