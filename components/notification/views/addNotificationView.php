...
<div class="featureBody bodyBackground text">
    <form id="form" method="post" class="container">
        ...
        <div class="row col-2">
            <div>
                <label class="subHeading" id="">Title:</label>
                <div class="row col-1">
                    <textarea class="textareaStyle" name="title" rows="1" cols="130" required></textarea>
                </div>
                <label class="subHeading" id="">Message:</label>
                <div class="row col-1">
                    <textarea class="textareaStyle" name="message" rows="7" cols="130" required></textarea>
                </div>
            </div>
        ...
        <div class="row col-2">
            <div><label class="subHeading" id="category">Category:</label>
                <div class="radioToolbar row col-3">
                    <div>
                        <input value="2300" type="radio" id="radioDirectorNotices" name="category" required>
                        <label class="category" for="radioDirectorNotices">Director Notices</label>
                    </div>
                    <div>
                        <input value="2200" type="radio" id="radioSocial&Events" name="category" required>
                        <label class="category" for="radioSocial&Events">Social & Events</label>
                    </div>
                    <div>
                        <input value="2400" type="radio" id="radioFundraisingEvents" name="category" required>
                        <label class="category" for="radioFundraisingEvents">Fundraising Events</label>
                    </div>
                    <div>
                        <input value="2500" type="radio" id="radioAdministrative&Exam" name="category" required>
                        <label class="category" for="radioAdministrative&Exam">Administrative & Exam</label>
                    </div>
                    <div>
                        <input value="2100" type="radio" id="radioAssignmentScholarship&LectureRe-scheduling" name="category" required>
                        <label class="special" for="radioAssignmentScholarship&LectureRe-scheduling">Assignment, Scholarship & Lecture
                            Re-scheduling</label>
                    </div>
                    <div>
                        <input value="2700" type="radio" id="other" name="category" required>
            ...
            <div class="weeks">
                ...
                <input type="number" id="weeks" name="weeks" required><br>
