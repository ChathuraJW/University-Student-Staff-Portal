            ...
            <div class="subTab previousAppointments">
                ...
                <div class="list">
					<?php
						...
						if (isset($dataSet) && count($dataSet)) {
                            ...
                            <form action="" method="post">
                                <div class="ttl">
                                    <div class="row col-1">
                                        ...
                                        <textarea style="background-color:var(--entryBackgroundColor);" class="reply" type="textarea" id=""
                                                  name="reply" placeholder="Reply"></textarea>
