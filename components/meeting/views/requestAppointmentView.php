...
<div class="featureBody bodyBackground text">
    <div class="navigationBar">
        <button id="linkFirst" class="navigationLink" style="background-color: rgb(58, 189, 212);" onclick="openTab('tabFirst');hover('linkFirst');">
            New Appointment
        </button>
			...
			<?php if (count($records)): ?>
				...
				<?php foreach ($records as $record) { ?>
                    ...
                    <div class="row col-1">
                        ...
                        <a href='<?php echo $url; ?>' id="<?php echo $record->getIsApproved(); ?>" class="appointment">
                            <div style="margin-bottom:10px;" class="appointmentDescription messageHead"><?php echo $record->getTitle(); ?></div>
                            <div class="appointmentDescription"><?php echo substr($record->getMessage(), 0, 80); ?> </div>
                            <div class="appointmentDescription" style="float:right;"><i class='fa fa-clock-o'
                                                                                        aria-hidden='true'></i> <?php echo $record->getTimestamp(); ?>
                            </div>
                        </a><br>
