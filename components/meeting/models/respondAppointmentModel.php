<?php
    class RespondAppointmentModel extends Model{
        public static function getData(){
            ...
            $current=date("Y-m-d");
            $queryOne="SELECT * FROM meeting_appointment WHERE staffID='$staffID' AND isApproved='N' AND appointmentDate>='$current' AND requestValidity=1";
        ...
        public static function insertData($reply,$approve,$validity,$appointmentID){
            ...
            $query="UPDATE meeting_appointment SET reply='$reply' ,isApproved='$approve' ,requestValidity=$validity WHERE appointmentID=$appointmentID";
